        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: "1rem" }}>
          ...
          <div className="card shadow-sm" style={{ padding: "1.1rem", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              ...
              <h4 style={{ margin: "0 0 0.4rem 0", fontSize: "0.9rem", fontWeight: 700, color: "var(--text-primary)" }}>2. Examination Studio</h4>
              <p style={{ margin: 0, fontSize: "0.8rem", color: "var(--text-secondary)", lineHeight: 1.45 }}>
                Attempt national standard Paper I (MCQ) and Paper II (Structured & Essay) examinations with instant grading and detailed feedback.
              </p>
            </div>
            <Link href="/dashboard/student/al-exams" onClick={onClose} className="btn-secondary btn-sm" style={{ textDecoration: "none", marginTop: "1rem", fontSize: "0.75rem", width: "fit-content" }}>
              Exam Studio
            </Link>
          </div>
          ...
          <div className="card shadow-sm" style={{ padding: "1.1rem", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              ...
              <h4 style={{ margin: "0 0 0.4rem 0", fontSize: "0.9rem", fontWeight: 700, color: "var(--text-primary)" }}>3. Learning Analytics</h4>
              <p style={{ margin: 0, fontSize: "0.8rem", color: "var(--text-secondary)", lineHeight: 1.45 }}>
                Track your syllabus mastery, topic performance, cognitive levels, and question discrimination trends.
              </p>
            </div>
            <Link href="/dashboard/student/analytics" onClick={onClose} className="btn-secondary btn-sm" style={{ textDecoration: "none", marginTop: "1rem", fontSize: "0.75rem", width: "fit-content" }}>
              My Analytics
            </Link>
          </div>
