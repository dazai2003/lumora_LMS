        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: "1rem" }}>
          ...
          <div className="card shadow-sm" style={{ padding: "1.1rem", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              ...
              <h4 style={{ margin: "0 0 0.4rem 0", fontSize: "0.9rem", fontWeight: 700, color: "var(--text-primary)" }}>2. SpeedGrader Queue</h4>
              <p style={{ margin: 0, fontSize: "0.8rem", color: "var(--text-secondary)", lineHeight: 1.45 }}>
                Evaluate written essay submissions using multi-criteria grading rubrics, inline comments, and instant feedback.
              </p>
            </div>
            <Link href="/dashboard/teacher/grading" onClick={onClose} className="btn-secondary btn-sm" style={{ textDecoration: "none", marginTop: "1rem", fontSize: "0.75rem", width: "fit-content" }}>
              Grading Queue
            </Link>
          </div>
          ...
          <div className="card shadow-sm" style={{ padding: "1.1rem", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              ...
              <h4 style={{ margin: "0 0 0.4rem 0", fontSize: "0.9rem", fontWeight: 700, color: "var(--text-primary)" }}>3. Question Bank & Quizzes</h4>
              <p style={{ margin: 0, fontSize: "0.8rem", color: "var(--text-secondary)", lineHeight: 1.45 }}>
                Build questions tagged by Bloom's cognitive taxonomy, import from Question Bank, and generate automated quizzes.
              </p>
            </div>
            <Link href="/dashboard/teacher/question-bank" onClick={onClose} className="btn-secondary btn-sm" style={{ textDecoration: "none", marginTop: "1rem", fontSize: "0.75rem", width: "fit-content" }}>
              Question Bank
            </Link>
          </div>
