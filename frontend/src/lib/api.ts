...
class ApiClient {
  ...
  private async request<T>(
    ...
    // Configure resilient timeout (300s for AI generation to accommodate probe-first backoff strategy, 35s for standard endpoints)
    ...
    const effectiveTimeout = timeoutMs || (isAiEndpoint ? 300000 : 35000);
