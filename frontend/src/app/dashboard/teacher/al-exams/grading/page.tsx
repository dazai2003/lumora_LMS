                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", flex: 1, minWidth: "280px" }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem", flexWrap: "wrap" }}>
                      <span className={`badge ${isVerified ? "badge-success" : paperType === "paper_1_mcq" ? "badge-info" : "badge-warning"}`} style={{ fontWeight: 700, fontSize: "0.7rem", letterSpacing: "0.02em" }}>
                        {isVerified ? "TEACHER VERIFIED" : paperType === "paper_1_mcq" ? "AUTO-GRADED (MCQ)" : "PENDING TEACHER MARKING"}
                      </span>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", flexShrink: 0 }}>
                  ...
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: "0.68rem", color: "var(--text-muted)", textTransform: "uppercase", fontWeight: 700 }}>
                      {isVerified || paperType === "paper_1_mcq" ? "Final Grade" : "Marking Status"}
                    </div>
                  ...
                  >
                    <SvgIcon name={isVerified ? "eye" : "check-circle"} size={15} />
                    <span>{isVerified ? "Review Marks" : "Grade Script"}</span>
                  </Link>
                </div>
              </div>
            );
